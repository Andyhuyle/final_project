#' Merge Ridership and Schedule Data into Hourly Summary
#'
#' This function takes aggregated ridership and schedule datasets, merges them by Route and Hour,
...
map_ridership <- function(ridership_agg, otp_agg) {
  ...
  # Replace any remaining NAs (e.g., other numeric columns) with 0
